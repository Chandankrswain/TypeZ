export const InfoPage = () => {
  return (
    <div className="p-6 max-w-3xl mx-auto text-lg text-gray-700">
      <h1 className="text-3xl font-bold text-center mb-6">
        Enhancing Your Typing Skills, One Word at a Time
      </h1>

      <p className="mb-4">
        Welcome to <strong>[Your Project Name]</strong>, the ultimate typing
        experience designed to help you{" "}
        <strong>improve speed, accuracy, and efficiency</strong>. Whether you're
        a beginner looking to level up your typing or a pro aiming for high WPM
        scores, our platform is built for you!
      </p>
      ...
      <p className="mb-4">
        Unlike traditional typing tests, <strong>[Your Project Name]</strong> is
        built using the latest technologies like{" "}
        <strong>React, Framer Motion, Redux, and TailwindCSS</strong>, ensuring
        a<strong> fast, responsive, and visually appealing experience</strong>.
      </p>
      <p>
